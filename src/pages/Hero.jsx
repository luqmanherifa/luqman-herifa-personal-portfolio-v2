      ...
      >
        <div>
          <motion.h1
            ...
            transition={{ delay: 0 }}
            className="mb-6 text-center text-6xl font-semibold tracking-tight text-slate-100 drop-shadow-sm dark:font-extrabold dark:text-blue-600 lg:text-5xl md:text-5xl sm:text-left sm:text-5xl sm:font-bold"
          >
            Halo! <br className="hidden sm:block" />
            Dive into
            <br className="sm:block" />
            <span className="bg-gradient-to-r from-cyan-500 via-indigo-500 to-pink-500 bg-clip-text font-bold text-transparent dark:text-blue-600">
              Luqman Blueprints
            </span>
          </motion.h1>
          <motion.div
            ...
            animate={{ y: [100, 0], opacity: 1 }}
            transition={{ delay: 0 }}
            className="flex flex-col items-center justify-center gap-4 px-4 sm:flex-row sm:justify-start"
          >

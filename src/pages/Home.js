...
export default function Home() {
  ...
  return (
    <section className="pb-28 sm:pb-10">
      <div className="max-w-6xl mx-auto py-28 bg-pattern bg-no-repeat bg-center sm:max-w-xs sm:py-10">
        <div>
          <h1 className="text-white mb-6 font-extrabold text-6xl text-center tracking-tight sm:text-5xl sm:text-left sm:font-bold">

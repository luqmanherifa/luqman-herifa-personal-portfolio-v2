      ...
      <div>
        <div className="mx-auto flex max-w-3xl flex-col items-center justify-center pt-9 xl:max-w-4xl lg:max-w-xl md:max-w-lg sm:max-w-xs sm:pt-9">
          ...
          <motion.p
            ...
            animate={{ x: [-150, 0], opacity: 1 }}
            transition={{ delay: 0.1 }}
            className="mt-4 flex items-center justify-center gap-1 text-center text-base italic text-white dark:text-white"
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 640 640"
              className="h-3.5 w-3.5 fill-current text-white dark:text-white"
            >
      ...
      `}
            ...
            >
              <motion.p
                ...
                animate={{ x: [-150, 0], opacity: 1 }}
                transition={{ delay: 0.1 }}
                className="text-center text-base text-blue-400 hover:text-blue-500 hover:underline dark:text-white dark:hover:text-blue-300"
              >
